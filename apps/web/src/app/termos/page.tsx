  ...
  return (
    <div className="flex min-h-screen flex-col bg-bg">
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-6 font-display text-2xl font-bold text-text sm:text-3xl">Termos de Uso</h1>
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-text-muted">
          <section>
            <h2 className="text-lg font-bold text-text">1. Sobre o serviço</h2>
            <p className="mt-2">
              ...
              <span className="font-medium text-text">860.763.795-96</span>, doravante
              &quot;educar-se-ia&quot; ou &quot;nós&quot;.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-text">2. Cadastro e conta</h2>
            <p className="mt-2">
              ...
              <Link href="/conta" className="underline hover:text-text">Minha Conta</Link>.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-text">3. Planos, cobrança e cancelamento</h2>
            <p className="mt-2">
              O educar-se-ia oferece um plano gratuito com limites de uso e planos pagos com recursos
              adicionais, descritos na página{' '}
              <Link href="/planos" className="underline hover:text-text">Planos</Link>. Pagamentos são
          ...
          <section>
            <h2 className="text-lg font-bold text-text">4. Conteúdo gerado por inteligência artificial</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-text">5. Uso aceitável e conteúdo enviado</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-text">6. Limitação de responsabilidade</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-text">7. Alterações nestes termos</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-text">8. Lei aplicável e foro</h2>
            <p className="mt-2">
              Estes termos são regidos pelas leis da República Federativa do Brasil. Fica eleito o foro da
              comarca de <span className="font-medium text-text">Salvador/Bahia</span> para dirimir
              eventuais conflitos, salvo disposição em contrário da legislação aplicável.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-text">9. Contato</h2>
            <p className="mt-2">
